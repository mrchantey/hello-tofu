...
pub struct AwsApiGatewayRestApiDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub endpoint_configuration: Option<Vec<AwsApiGatewayRestApiResourceBlockTypeEndpointConfiguration>>,
}
...
pub struct AwsApigatewayv2ApiDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cors_configuration: Option<Vec<AwsApigatewayv2ApiResourceBlockTypeCorsConfiguration>>,
}
...
pub struct AwsApigatewayv2IntegrationDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub response_parameters: Option<Vec<AwsApigatewayv2IntegrationResourceBlockTypeResponseParameters>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct AwsApigatewayv2RouteDetails {
    ...
    pub target: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub request_parameter: Option<Vec<AwsApigatewayv2RouteResourceBlockTypeRequestParameter>>,
}
...
pub struct AwsApigatewayv2StageDetails {
    ...
    pub tags_all: Option<Map<String, String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub access_log_settings: Option<Vec<AwsApigatewayv2StageResourceBlockTypeAccessLogSettings>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub default_route_settings: Option<Vec<AwsApigatewayv2StageResourceBlockTypeDefaultRouteSettings>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct AwsLambdaFunctionDetails {
    ...
    pub version: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dead_letter_config: Option<Vec<AwsLambdaFunctionResourceBlockTypeDeadLetterConfig>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ephemeral_storage: Option<Vec<AwsLambdaFunctionResourceBlockTypeEphemeralStorage>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub file_system_config: Option<Vec<AwsLambdaFunctionResourceBlockTypeFileSystemConfig>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct AwsS3BucketDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub object_lock_configuration: Option<Vec<AwsS3BucketResourceBlockTypeObjectLockConfiguration>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub replication_configuration: Option<Vec<AwsS3BucketResourceBlockTypeReplicationConfiguration>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct AwsS3BucketResourceBlockTypeLifecycleRule {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub noncurrent_version_expiration: Option<Vec<LifecycleRuleResourceBlockTypeNoncurrentVersionExpiration>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub noncurrent_version_transition: Option<Vec<LifecycleRuleResourceBlockTypeNoncurrentVersionTransition>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct RulesResourceBlockTypeDestination {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub access_control_translation: Option<Vec<DestinationResourceBlockTypeAccessControlTranslation>>,
    #[serde(skip_serializing_if = "Option::is_none")]
